            ...
            "aoColumnDefs": [
                @if($values['isSysAdmin'])
                {
                    ...
                    "mRender": function (data, type, full) {
                        var iCol = 0;
                        var _val = '<a href="/admin/patients/' + data[4] + '/edit_patients">' + data[iCol] + '</a>';
                        _val += '<a data_href="/admin/users/' + data[4] + '"class="remove_patient remove-option"><i class="icon_minus_alt"></i></a>';
                        return _val;
                    }
                },
                {
                    ...
                    @endif
                {
                    ...
                    "mRender": function (data, type, full) {
                        var _val = '<a href="/admin/patients/' + data[4] + '/report" class="btn btn-sm btn-primary" type="button">View Report</a>';
                        return _val;
                    }
                }
            ],
