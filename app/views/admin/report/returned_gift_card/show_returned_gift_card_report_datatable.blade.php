<table id="{{ $id }}" class="{{ $class }}">
    <thead>
    <?php
    $columns_count = ($values['program']->type == \Program::TYPE_POSTPARTUM) ? 30 : 27;
    ?>
    <tr>
...
@section('scripts')
    ...
    <script>
        mytable = $('table').DataTable({
            ...
            "stateSave": true,
            columns: [
                null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null @if($values['program']->type == \Program::TYPE_POSTPARTUM), null, null, null @endif
            ],
