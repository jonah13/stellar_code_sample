        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="input-group input-group-lg sepH_a pregnancy_report_type_area" style="display: none;">
                    {{ Form::label('pregnancy_report_type', 'Report Type : ', array('class' => 'control-label')) }}
                    {{ Form::radio('pregnancy_report_type', \Program::PREGNANCY_REPORT_ACTIVE, true) }} Active Patient
                    Report<br>
                    {{ Form::radio('pregnancy_report_type', \Program::PREGNANCY_REPORT_DELIVERY) }} Delivery Report
                </div>
